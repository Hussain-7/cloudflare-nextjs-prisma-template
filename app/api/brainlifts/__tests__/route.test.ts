...
import type { BrainliftApiResponse, ApiErrorResponse, MockBrainlift } from '../../../types'
...
describe('/api/brainlifts', () => {
  ...
  it('should return brainlifts data', async () => {
    ...
    vi.mocked(prisma.default.brainlift.findMany).mockResolvedValue(mockBrainlifts)
  ...
  it('should handle errors gracefully', async () => {
    const prisma = await import('@/lib/db/prisma')
    vi.mocked(prisma.default.brainlift.findMany).mockRejectedValue(new Error('Database error'))
